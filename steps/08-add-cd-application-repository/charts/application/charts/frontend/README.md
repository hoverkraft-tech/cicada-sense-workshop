...
Cicada Sense frontend workload
...
| image.repository                                  | string | `"cicada-sense/frontend"`    |             |
...
| volumeMounts[0].name                              | string | `"nginx-cache"`              |             |
| volumeMounts[1].mountPath                         | string | `"/var/run"`                 |             |
| volumeMounts[1].name                              | string | `"nginx-run"`                |             |
| volumeMounts[2].mountPath                         | string | `"/tmp"`                     |             |
| volumeMounts[2].name                              | string | `"nginx-tmp"`                |             |
| volumes[0].emptyDir                               | object | `{}`                         |             |
| volumes[0].name                                   | string | `"nginx-cache"`              |             |
| volumes[1].emptyDir                               | object | `{}`                         |             |
| volumes[1].name                                   | string | `"nginx-run"`                |             |
| volumes[2].emptyDir                               | object | `{}`                         |             |
| volumes[2].name                                   | string | `"nginx-tmp"`                |             |
